...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/areaFunc.css')); ?>">
...
<body>
    <nav class="barra-navegador">
        <ul>
            <li><a href="<?php echo e(route('/')); ?>#pag-inicial"><img src="<?php echo e(asset('img/barbearia-frente.png')); ?>" alt="" style="height: 25px; width: 25px;"></a></li>
            <li><a href="<?php echo e(route('/')); ?>#pag-inicial">Pagina Inicial</a></li>
...
<script type="module" src="<?php echo e(asset('js/modules/index.js')); ?>"></script>

</html>
<?php /**PATH C:\Users\adm\Desktop\BarbeariaAguiaReal\back-end\resources\views/areafunc.blade.php ENDPATH**/ ?>