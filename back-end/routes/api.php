...
Route::get('/buscar/conta/{tipo}/{data}', [ContaController::class, 'buscarContaPorData'])->name('buscarContaPorData');

Route::post('/cadastrar/conta/{tipo}', [ContaController::class, 'cadastrarConta'])->name('cadastrarConta');
...
Route::put('/editar/conta/{tipo}/{id}', [ContaController::class, 'editarConta'])->name('editarConta');
