...
<body>
    <nav class="barra-navegador">
        <ul>
            <li><a href="#pag-inicial"><img src="{{ asset('img/barbearia-frente.png') }}" alt=""
                        style="height: 30px; width: 30px;"></a></li>
            <li><a href="#pag-inicial">Pagina Inicial</a></li>
            <li><a href="#servicos">Serviços</a></li>
            <li><a href="#contato">Contato</a></li>
            <li><a href="{{ route('areafunc')}}">Area do Funcionario</a></li>
        </ul>
    </nav>
    ...
    <div class="pag-inicial" id="pag-inicial">
        ...
        <div class="overlay">
            ...
            <button><a href="https://wa.me/61982436970" target="_blank"><img src="{{ asset('img/Whatsaap.png') }}"
    ...
    <div class="sobrenos" id="sobrenos">
        <div class="img-canto">
            <img src="{{ asset('img/ImagemAmostra3.jpg') }}" alt="">
            <div>
    ...
    <div class="contato" id="contato">
        ...
        <div class="colunas">
            ...
            <div class="item">
                <span>
                    <img src="{{ asset('img/Telefone.png') }}" alt="Telefone">
                    (61) 98243-6970 - (61) 98135-4110
                </span>

                <span>
                    <img src="{{ asset('img/Endereco.png') }}" alt="Endereço">
            ...
            <div class="item">
                <span>
                    <img src="{{ asset('img/Relogio.png') }}" alt="Horário">
            ...
            <div class="item">
                ...
                <a href="https://www.tiktok.com/@barbeariaaguiareal?_t=8sXqhJJ92yj&_r=1" target="_blank">
                    <img src="{{ asset('img/TikTok.webp') }}" alt="TikTok">
                    barbeariaaguiareal
                </a>
            </div>
        </div>
...
<script type="module" src="{{ asset('js/modules/index.js')}}" defer></script>
